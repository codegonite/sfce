...
// const struct sfce_utf8_property *sfce_codepoint_utf8_property_unchecked(int32_t codepoint)
// {
//     uint32_t page_offset = utf8_property_page_offsets[codepoint >> 7];
//     uint32_t index = utf8_property_indices[page_offset + (codepoint & 0x7F)];
...
enum sfce_unicode_category sfce_codepoint_category(int32_t codepoint)
{
    if (codepoint > -1 && codepoint < 888) return SFCE_UNICODE_CATEGORY_CC;
    if (codepoint > 889 && codepoint < 896) return SFCE_UNICODE_CATEGORY_LM;
    if (codepoint > 899 && codepoint < 907) return SFCE_UNICODE_CATEGORY_SK;
    if (codepoint > 909 && codepoint < 930) return SFCE_UNICODE_CATEGORY_LU;
    if (codepoint > 930 && codepoint < 1328) return SFCE_UNICODE_CATEGORY_LU;
    if (codepoint > 1328 && codepoint < 1367) return SFCE_UNICODE_CATEGORY_LU;
    if (codepoint > 1368 && codepoint < 1419) return SFCE_UNICODE_CATEGORY_LM;
    if (codepoint > 1420 && codepoint < 1424) return SFCE_UNICODE_CATEGORY_SO;
    if (codepoint > 1424 && codepoint < 1480) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 1487 && codepoint < 1515) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 1518 && codepoint < 1525) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 1535 && codepoint < 1806) return SFCE_UNICODE_CATEGORY_CF;
    if (codepoint > 1806 && codepoint < 1867) return SFCE_UNICODE_CATEGORY_CF;
    if (codepoint > 1868 && codepoint < 1970) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 1983 && codepoint < 2043) return SFCE_UNICODE_CATEGORY_ND;
    if (codepoint > 2044 && codepoint < 2094) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 2095 && codepoint < 2111) return SFCE_UNICODE_CATEGORY_PO;
    if (codepoint > 2111 && codepoint < 2140) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 2143 && codepoint < 2155) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 2159 && codepoint < 2191) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 2191 && codepoint < 2194) return SFCE_UNICODE_CATEGORY_CF;
    if (codepoint > 2198 && codepoint < 2436) return SFCE_UNICODE_CATEGORY_MN;
    ...
    if (codepoint > 2491 && codepoint < 2501) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 2502 && codepoint < 2505) return SFCE_UNICODE_CATEGORY_MC;
    if (codepoint > 2506 && codepoint < 2511) return SFCE_UNICODE_CATEGORY_MC;
    if (codepoint > 2523 && codepoint < 2526) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 2526 && codepoint < 2532) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 2533 && codepoint < 2559) return SFCE_UNICODE_CATEGORY_ND;
    if (codepoint > 2560 && codepoint < 2564) return SFCE_UNICODE_CATEGORY_MN;
    ...
    if (codepoint > 2621 && codepoint < 2627) return SFCE_UNICODE_CATEGORY_MC;
    ...
    if (codepoint > 2661 && codepoint < 2679) return SFCE_UNICODE_CATEGORY_ND;
    if (codepoint > 2688 && codepoint < 2692) return SFCE_UNICODE_CATEGORY_MN;
    ...
    if (codepoint > 2747 && codepoint < 2758) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 2758 && codepoint < 2762) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 2762 && codepoint < 2766) return SFCE_UNICODE_CATEGORY_MC;
    if (codepoint > 2783 && codepoint < 2788) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 2789 && codepoint < 2802) return SFCE_UNICODE_CATEGORY_ND;
    if (codepoint > 2808 && codepoint < 2816) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 2816 && codepoint < 2820) return SFCE_UNICODE_CATEGORY_MN;
    ...
    if (codepoint > 2875 && codepoint < 2885) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 2886 && codepoint < 2889) return SFCE_UNICODE_CATEGORY_MC;
    if (codepoint > 2890 && codepoint < 2894) return SFCE_UNICODE_CATEGORY_MC;
    if (codepoint > 2900 && codepoint < 2904) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 2907 && codepoint < 2910) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 2910 && codepoint < 2916) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 2917 && codepoint < 2936) return SFCE_UNICODE_CATEGORY_ND;
    if (codepoint > 2945 && codepoint < 2948) return SFCE_UNICODE_CATEGORY_MN;
    ...
    if (codepoint > 3005 && codepoint < 3011) return SFCE_UNICODE_CATEGORY_MC;
    if (codepoint > 3013 && codepoint < 3017) return SFCE_UNICODE_CATEGORY_MC;
    if (codepoint > 3017 && codepoint < 3022) return SFCE_UNICODE_CATEGORY_MC;
    if (codepoint > 3045 && codepoint < 3067) return SFCE_UNICODE_CATEGORY_ND;
    if (codepoint > 3071 && codepoint < 3085) return SFCE_UNICODE_CATEGORY_MN;
    ...
    if (codepoint > 3131 && codepoint < 3141) return SFCE_UNICODE_CATEGORY_MN;
    ...
    if (codepoint > 3167 && codepoint < 3172) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 3173 && codepoint < 3184) return SFCE_UNICODE_CATEGORY_ND;
    if (codepoint > 3190 && codepoint < 3213) return SFCE_UNICODE_CATEGORY_PO;
    ...
    if (codepoint > 3259 && codepoint < 3269) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 3269 && codepoint < 3273) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 3273 && codepoint < 3278) return SFCE_UNICODE_CATEGORY_MC;
    ...
    if (codepoint > 3295 && codepoint < 3300) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 3301 && codepoint < 3312) return SFCE_UNICODE_CATEGORY_ND;
    if (codepoint > 3312 && codepoint < 3316) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 3327 && codepoint < 3341) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 3341 && codepoint < 3345) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 3345 && codepoint < 3397) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 3397 && codepoint < 3401) return SFCE_UNICODE_CATEGORY_MC;
    if (codepoint > 3401 && codepoint < 3408) return SFCE_UNICODE_CATEGORY_MC;
    if (codepoint > 3411 && codepoint < 3428) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 3429 && codepoint < 3456) return SFCE_UNICODE_CATEGORY_ND;
    if (codepoint > 3456 && codepoint < 3460) return SFCE_UNICODE_CATEGORY_MN;
    ...
    if (codepoint > 3534 && codepoint < 3541) return SFCE_UNICODE_CATEGORY_MC;
    ...
    if (codepoint > 3569 && codepoint < 3573) return SFCE_UNICODE_CATEGORY_MC;
    if (codepoint > 3584 && codepoint < 3643) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 3646 && codepoint < 3676) return SFCE_UNICODE_CATEGORY_SC;
    ...
    if (codepoint > 3750 && codepoint < 3774) return SFCE_UNICODE_CATEGORY_LO;
    ...
    if (codepoint > 3839 && codepoint < 3912) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 3912 && codepoint < 3949) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 3952 && codepoint < 3992) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 3992 && codepoint < 4029) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 4029 && codepoint < 4045) return SFCE_UNICODE_CATEGORY_SO;
    if (codepoint > 4045 && codepoint < 4059) return SFCE_UNICODE_CATEGORY_SO;
    if (codepoint > 4095 && codepoint < 4294) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 4303 && codepoint < 4681) return SFCE_UNICODE_CATEGORY_LL;
    ...
    if (codepoint > 4956 && codepoint < 4989) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 4991 && codepoint < 5018) return SFCE_UNICODE_CATEGORY_LO;
    ...
    if (codepoint > 5119 && codepoint < 5789) return SFCE_UNICODE_CATEGORY_PD;
    if (codepoint > 5791 && codepoint < 5881) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 5887 && codepoint < 5910) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 5918 && codepoint < 5943) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 5951 && codepoint < 5972) return SFCE_UNICODE_CATEGORY_LO;
    ...
    if (codepoint > 6015 && codepoint < 6110) return SFCE_UNICODE_CATEGORY_LO;
    ...
    if (codepoint > 6143 && codepoint < 6170) return SFCE_UNICODE_CATEGORY_PO;
    if (codepoint > 6175 && codepoint < 6265) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 6271 && codepoint < 6315) return SFCE_UNICODE_CATEGORY_LO;
    ...
    if (codepoint > 6431 && codepoint < 6444) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 6447 && codepoint < 6460) return SFCE_UNICODE_CATEGORY_MC;
    if (codepoint > 6467 && codepoint < 6510) return SFCE_UNICODE_CATEGORY_PO;
    ...
    if (codepoint > 6607 && codepoint < 6619) return SFCE_UNICODE_CATEGORY_ND;
    if (codepoint > 6621 && codepoint < 6684) return SFCE_UNICODE_CATEGORY_SO;
    if (codepoint > 6685 && codepoint < 6751) return SFCE_UNICODE_CATEGORY_PO;
    if (codepoint > 6751 && codepoint < 6781) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 6782 && codepoint < 6794) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 6799 && codepoint < 6810) return SFCE_UNICODE_CATEGORY_ND;
    if (codepoint > 6815 && codepoint < 6830) return SFCE_UNICODE_CATEGORY_PO;
    if (codepoint > 6831 && codepoint < 6863) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 6911 && codepoint < 6989) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 6989 && codepoint < 7156) return SFCE_UNICODE_CATEGORY_PO;
    if (codepoint > 7163 && codepoint < 7224) return SFCE_UNICODE_CATEGORY_PO;
    if (codepoint > 7226 && codepoint < 7242) return SFCE_UNICODE_CATEGORY_PO;
    if (codepoint > 7244 && codepoint < 7307) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 7311 && codepoint < 7355) return SFCE_UNICODE_CATEGORY_LU;
    if (codepoint > 7356 && codepoint < 7368) return SFCE_UNICODE_CATEGORY_LU;
    if (codepoint > 7375 && codepoint < 7419) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 7423 && codepoint < 7958) return SFCE_UNICODE_CATEGORY_LL;
    if (codepoint > 7959 && codepoint < 7966) return SFCE_UNICODE_CATEGORY_LU;
    if (codepoint > 7967 && codepoint < 8006) return SFCE_UNICODE_CATEGORY_LL;
    ...
    if (codepoint > 8030 && codepoint < 8062) return SFCE_UNICODE_CATEGORY_LU;
    if (codepoint > 8063 && codepoint < 8117) return SFCE_UNICODE_CATEGORY_LL;
    if (codepoint > 8117 && codepoint < 8133) return SFCE_UNICODE_CATEGORY_LL;
    if (codepoint > 8133 && codepoint < 8148) return SFCE_UNICODE_CATEGORY_LL;
    if (codepoint > 8149 && codepoint < 8156) return SFCE_UNICODE_CATEGORY_LL;
    if (codepoint > 8156 && codepoint < 8176) return SFCE_UNICODE_CATEGORY_SK;
    if (codepoint > 8177 && codepoint < 8181) return SFCE_UNICODE_CATEGORY_LL;
    if (codepoint > 8181 && codepoint < 8191) return SFCE_UNICODE_CATEGORY_LL;
    if (codepoint > 8191 && codepoint < 8293) return SFCE_UNICODE_CATEGORY_ZS;
    if (codepoint > 8293 && codepoint < 8306) return SFCE_UNICODE_CATEGORY_CF;
    if (codepoint > 8307 && codepoint < 8335) return SFCE_UNICODE_CATEGORY_NO;
    ...
    if (codepoint > 8399 && codepoint < 8433) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 8447 && codepoint < 8588) return SFCE_UNICODE_CATEGORY_SO;
    if (codepoint > 8591 && codepoint < 9258) return SFCE_UNICODE_CATEGORY_SM;
    if (codepoint > 9279 && codepoint < 9291) return SFCE_UNICODE_CATEGORY_SO;
    if (codepoint > 9311 && codepoint < 11124) return SFCE_UNICODE_CATEGORY_NO;
    if (codepoint > 11125 && codepoint < 11158) return SFCE_UNICODE_CATEGORY_SO;
    if (codepoint > 11158 && codepoint < 11508) return SFCE_UNICODE_CATEGORY_SO;
    if (codepoint > 11512 && codepoint < 11558) return SFCE_UNICODE_CATEGORY_PO;
    if (codepoint > 11567 && codepoint < 11624) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 11630 && codepoint < 11633) return SFCE_UNICODE_CATEGORY_LM;
    if (codepoint > 11646 && codepoint < 11671) return SFCE_UNICODE_CATEGORY_MN;
    ...
    if (codepoint > 11743 && codepoint < 11870) return SFCE_UNICODE_CATEGORY_MN;
    ...
    if (codepoint > 12271 && codepoint < 12352) return SFCE_UNICODE_CATEGORY_SO;
    if (codepoint > 12352 && codepoint < 12439) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 12440 && codepoint < 12544) return SFCE_UNICODE_CATEGORY_MN;
    ...
    if (codepoint > 12687 && codepoint < 12774) return SFCE_UNICODE_CATEGORY_SO;
    if (codepoint > 12782 && codepoint < 12831) return SFCE_UNICODE_CATEGORY_SO;
    if (codepoint > 12831 && codepoint < 13313) return SFCE_UNICODE_CATEGORY_NO;
    if (codepoint > 19902 && codepoint < 19969) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 40958 && codepoint < 42125) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 42127 && codepoint < 42183) return SFCE_UNICODE_CATEGORY_SO;
    if (codepoint > 42191 && codepoint < 42540) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 42559 && codepoint < 42744) return SFCE_UNICODE_CATEGORY_LU;
    if (codepoint > 42751 && codepoint < 42958) return SFCE_UNICODE_CATEGORY_SK;
    if (codepoint > 42959 && codepoint < 42962) return SFCE_UNICODE_CATEGORY_LU;
    if (codepoint > 42964 && codepoint < 42973) return SFCE_UNICODE_CATEGORY_LL;
    if (codepoint > 42993 && codepoint < 43053) return SFCE_UNICODE_CATEGORY_LM;
    if (codepoint > 43055 && codepoint < 43066) return SFCE_UNICODE_CATEGORY_NO;
    if (codepoint > 43071 && codepoint < 43128) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 43135 && codepoint < 43206) return SFCE_UNICODE_CATEGORY_MC;
    if (codepoint > 43213 && codepoint < 43226) return SFCE_UNICODE_CATEGORY_PO;
    if (codepoint > 43231 && codepoint < 43348) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 43358 && codepoint < 43389) return SFCE_UNICODE_CATEGORY_PO;
    if (codepoint > 43391 && codepoint < 43470) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 43470 && codepoint < 43482) return SFCE_UNICODE_CATEGORY_LM;
    if (codepoint > 43485 && codepoint < 43519) return SFCE_UNICODE_CATEGORY_PO;
    if (codepoint > 43519 && codepoint < 43575) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 43583 && codepoint < 43598) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 43599 && codepoint < 43610) return SFCE_UNICODE_CATEGORY_ND;
    if (codepoint > 43611 && codepoint < 43715) return SFCE_UNICODE_CATEGORY_PO;
    if (codepoint > 43738 && codepoint < 43767) return SFCE_UNICODE_CATEGORY_LO;
    ...
    if (codepoint > 43823 && codepoint < 43884) return SFCE_UNICODE_CATEGORY_LL;
    if (codepoint > 43887 && codepoint < 44014) return SFCE_UNICODE_CATEGORY_LL;
    ...
    if (codepoint > 57342 && codepoint < 57345) return SFCE_UNICODE_CATEGORY_CS;
    if (codepoint > 63742 && codepoint < 64110) return SFCE_UNICODE_CATEGORY_CO;
    ...
    if (codepoint > 64284 && codepoint < 64311) return SFCE_UNICODE_CATEGORY_LO;
    ...
    if (codepoint > 64325 && codepoint < 64451) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 64466 && codepoint < 64912) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 64913 && codepoint < 64968) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 65007 && codepoint < 65050) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 65055 && codepoint < 65107) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 65107 && codepoint < 65127) return SFCE_UNICODE_CATEGORY_PO;
    if (codepoint > 65127 && codepoint < 65132) return SFCE_UNICODE_CATEGORY_PO;
    ...
    if (codepoint > 65280 && codepoint < 65471) return SFCE_UNICODE_CATEGORY_PO;
    ...
    if (codepoint > 65503 && codepoint < 65511) return SFCE_UNICODE_CATEGORY_SC;
    if (codepoint > 65511 && codepoint < 65519) return SFCE_UNICODE_CATEGORY_SO;
    if (codepoint > 65528 && codepoint < 65534) return SFCE_UNICODE_CATEGORY_CF;
    ...
    if (codepoint > 65846 && codepoint < 65935) return SFCE_UNICODE_CATEGORY_SO;
    if (codepoint > 65935 && codepoint < 65949) return SFCE_UNICODE_CATEGORY_SO;
    if (codepoint > 65999 && codepoint < 66046) return SFCE_UNICODE_CATEGORY_SO;
    ...
    if (codepoint > 66271 && codepoint < 66300) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 66303 && codepoint < 66340) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 66348 && codepoint < 66379) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 66383 && codepoint < 66427) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 66431 && codepoint < 66462) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 66462 && codepoint < 66500) return SFCE_UNICODE_CATEGORY_PO;
    if (codepoint > 66503 && codepoint < 66518) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 66559 && codepoint < 66718) return SFCE_UNICODE_CATEGORY_LU;
    ...
    if (codepoint > 66926 && codepoint < 66939) return SFCE_UNICODE_CATEGORY_PO;
    ...
    if (codepoint > 67670 && codepoint < 67743) return SFCE_UNICODE_CATEGORY_PO;
    ...
    if (codepoint > 67834 && codepoint < 67868) return SFCE_UNICODE_CATEGORY_NO;
    if (codepoint > 67870 && codepoint < 67898) return SFCE_UNICODE_CATEGORY_PO;
    if (codepoint > 67967 && codepoint < 68024) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 68027 && codepoint < 68048) return SFCE_UNICODE_CATEGORY_NO;
    if (codepoint > 68049 && codepoint < 68100) return SFCE_UNICODE_CATEGORY_NO;
    if (codepoint > 68100 && codepoint < 68103) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 68107 && codepoint < 68116) return SFCE_UNICODE_CATEGORY_MN;
    ...
    if (codepoint > 68158 && codepoint < 68169) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 68175 && codepoint < 68185) return SFCE_UNICODE_CATEGORY_PO;
    if (codepoint > 68191 && codepoint < 68256) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 68287 && codepoint < 68327) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 68330 && codepoint < 68343) return SFCE_UNICODE_CATEGORY_NO;
    if (codepoint > 68351 && codepoint < 68406) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 68408 && codepoint < 68438) return SFCE_UNICODE_CATEGORY_PO;
    if (codepoint > 68439 && codepoint < 68467) return SFCE_UNICODE_CATEGORY_NO;
    if (codepoint > 68471 && codepoint < 68498) return SFCE_UNICODE_CATEGORY_NO;
    ...
    if (codepoint > 68857 && codepoint < 68904) return SFCE_UNICODE_CATEGORY_NO;
    if (codepoint > 68911 && codepoint < 68922) return SFCE_UNICODE_CATEGORY_ND;
    if (codepoint > 68927 && codepoint < 68966) return SFCE_UNICODE_CATEGORY_ND;
    if (codepoint > 68968 && codepoint < 68998) return SFCE_UNICODE_CATEGORY_MN;
    ...
    if (codepoint > 69290 && codepoint < 69294) return SFCE_UNICODE_CATEGORY_MN;
    ...
    if (codepoint > 69371 && codepoint < 69416) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 69423 && codepoint < 69466) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 69487 && codepoint < 69514) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 69551 && codepoint < 69580) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 69599 && codepoint < 69623) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 69631 && codepoint < 69710) return SFCE_UNICODE_CATEGORY_MC;
    if (codepoint > 69713 && codepoint < 69750) return SFCE_UNICODE_CATEGORY_NO;
    if (codepoint > 69758 && codepoint < 69827) return SFCE_UNICODE_CATEGORY_MN;
    ...
    if (codepoint > 69887 && codepoint < 69941) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 69941 && codepoint < 69960) return SFCE_UNICODE_CATEGORY_ND;
    if (codepoint > 69967 && codepoint < 70007) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 70015 && codepoint < 70112) return SFCE_UNICODE_CATEGORY_MN;
    ...
    if (codepoint > 70162 && codepoint < 70210) return SFCE_UNICODE_CATEGORY_LO;
    ...
    if (codepoint > 70302 && codepoint < 70314) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 70319 && codepoint < 70379) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 70383 && codepoint < 70394) return SFCE_UNICODE_CATEGORY_ND;
    if (codepoint > 70399 && codepoint < 70404) return SFCE_UNICODE_CATEGORY_MN;
    ...
    if (codepoint > 70458 && codepoint < 70469) return SFCE_UNICODE_CATEGORY_MN;
    ...
    if (codepoint > 70492 && codepoint < 70500) return SFCE_UNICODE_CATEGORY_LO;
    ...
    if (codepoint > 70582 && codepoint < 70593) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 70598 && codepoint < 70603) return SFCE_UNICODE_CATEGORY_MC;
    if (codepoint > 70603 && codepoint < 70614) return SFCE_UNICODE_CATEGORY_MC;
    ...
    if (codepoint > 70655 && codepoint < 70748) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 70748 && codepoint < 70754) return SFCE_UNICODE_CATEGORY_PO;
    if (codepoint > 70783 && codepoint < 70856) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 70863 && codepoint < 70874) return SFCE_UNICODE_CATEGORY_ND;
    if (codepoint > 71039 && codepoint < 71094) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 71095 && codepoint < 71134) return SFCE_UNICODE_CATEGORY_MC;
    if (codepoint > 71167 && codepoint < 71237) return SFCE_UNICODE_CATEGORY_LO;
    ...
    if (codepoint > 71295 && codepoint < 71354) return SFCE_UNICODE_CATEGORY_LO;
    ...
    if (codepoint > 71452 && codepoint < 71468) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 71471 && codepoint < 71495) return SFCE_UNICODE_CATEGORY_ND;
    if (codepoint > 71679 && codepoint < 71740) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 71839 && codepoint < 71923) return SFCE_UNICODE_CATEGORY_LU;
    ...
    if (codepoint > 71959 && codepoint < 71990) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 71990 && codepoint < 71993) return SFCE_UNICODE_CATEGORY_MC;
    if (codepoint > 71994 && codepoint < 72007) return SFCE_UNICODE_CATEGORY_MN;
    ...
    if (codepoint > 72105 && codepoint < 72152) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 72153 && codepoint < 72165) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 72191 && codepoint < 72264) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 72271 && codepoint < 72355) return SFCE_UNICODE_CATEGORY_LO;
    ...
    if (codepoint > 72639 && codepoint < 72674) return SFCE_UNICODE_CATEGORY_LO;
    ...
    if (codepoint > 72713 && codepoint < 72759) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 72759 && codepoint < 72774) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 72783 && codepoint < 72813) return SFCE_UNICODE_CATEGORY_ND;
    if (codepoint > 72815 && codepoint < 72848) return SFCE_UNICODE_CATEGORY_PO;
    if (codepoint > 72849 && codepoint < 72872) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 72872 && codepoint < 72887) return SFCE_UNICODE_CATEGORY_MC;
    ...
    if (codepoint > 72970 && codepoint < 73015) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 73019 && codepoint < 73022) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 73022 && codepoint < 73032) return SFCE_UNICODE_CATEGORY_MN;
    ...
    if (codepoint > 73065 && codepoint < 73103) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 73103 && codepoint < 73106) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 73106 && codepoint < 73113) return SFCE_UNICODE_CATEGORY_MC;
    if (codepoint > 73119 && codepoint < 73130) return SFCE_UNICODE_CATEGORY_ND;
    if (codepoint > 73439 && codepoint < 73465) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 73471 && codepoint < 73489) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 73489 && codepoint < 73531) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 73533 && codepoint < 73563) return SFCE_UNICODE_CATEGORY_MC;
    if (codepoint > 73663 && codepoint < 73714) return SFCE_UNICODE_CATEGORY_NO;
    if (codepoint > 73726 && codepoint < 74650) return SFCE_UNICODE_CATEGORY_PO;
    ...
    if (codepoint > 77711 && codepoint < 77811) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 77823 && codepoint < 78934) return SFCE_UNICODE_CATEGORY_LO;
    ...
    if (codepoint > 90367 && codepoint < 90426) return SFCE_UNICODE_CATEGORY_LO;
    ...
    if (codepoint > 92781 && codepoint < 92863) return SFCE_UNICODE_CATEGORY_PO;
    ...
    if (codepoint > 92911 && codepoint < 92918) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 92927 && codepoint < 92998) return SFCE_UNICODE_CATEGORY_LO;
    ...
    if (codepoint > 93503 && codepoint < 93562) return SFCE_UNICODE_CATEGORY_LM;
    if (codepoint > 93759 && codepoint < 93851) return SFCE_UNICODE_CATEGORY_LU;
    if (codepoint > 93951 && codepoint < 94027) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 94030 && codepoint < 94088) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 94094 && codepoint < 94112) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 94175 && codepoint < 94181) return SFCE_UNICODE_CATEGORY_LM;
    ...
    if (codepoint > 113819 && codepoint < 113828) return SFCE_UNICODE_CATEGORY_SO;
    if (codepoint > 117759 && codepoint < 118010) return SFCE_UNICODE_CATEGORY_SO;
    ...
    if (codepoint > 119080 && codepoint < 119275) return SFCE_UNICODE_CATEGORY_SO;
    if (codepoint > 119295 && codepoint < 119366) return SFCE_UNICODE_CATEGORY_SO;
    ...
    if (codepoint > 119807 && codepoint < 119893) return SFCE_UNICODE_CATEGORY_LU;
    if (codepoint > 119893 && codepoint < 119965) return SFCE_UNICODE_CATEGORY_LL;
    ...
    if (codepoint > 119981 && codepoint < 119994) return SFCE_UNICODE_CATEGORY_LU;
    if (codepoint > 119996 && codepoint < 120004) return SFCE_UNICODE_CATEGORY_LL;
    if (codepoint > 120004 && codepoint < 120070) return SFCE_UNICODE_CATEGORY_LL;
    ...
    if (codepoint > 120093 && codepoint < 120122) return SFCE_UNICODE_CATEGORY_LL;
    ...
    if (codepoint > 120145 && codepoint < 120486) return SFCE_UNICODE_CATEGORY_LL;
    if (codepoint > 120487 && codepoint < 120780) return SFCE_UNICODE_CATEGORY_LU;
    if (codepoint > 120781 && codepoint < 121484) return SFCE_UNICODE_CATEGORY_ND;
    ...
    if (codepoint > 122623 && codepoint < 122655) return SFCE_UNICODE_CATEGORY_LL;
    ...
    if (codepoint > 123183 && codepoint < 123198) return SFCE_UNICODE_CATEGORY_MN;
    if (codepoint > 123199 && codepoint < 123210) return SFCE_UNICODE_CATEGORY_ND;
    if (codepoint > 123213 && codepoint < 123216) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 123535 && codepoint < 123567) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 123583 && codepoint < 123642) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 124111 && codepoint < 124154) return SFCE_UNICODE_CATEGORY_LO;
    if (codepoint > 124367 && codepoint < 124411) return SFCE_UNICODE_CATEGORY_LO;
    ...
    if (codepoint > 125126 && codepoint < 125143) return SFCE_UNICODE_CATEGORY_NO;
    if (codepoint > 125183 && codepoint < 125260) return SFCE_UNICODE_CATEGORY_LU;
    ...
    if (codepoint > 126064 && codepoint < 126133) return SFCE_UNICODE_CATEGORY_NO;
    if (codepoint > 126208 && codepoint < 126270) return SFCE_UNICODE_CATEGORY_NO;
    ...
    if (codepoint > 127231 && codepoint < 127406) return SFCE_UNICODE_CATEGORY_NO;
    ...
    if (codepoint > 127743 && codepoint < 128728) return SFCE_UNICODE_CATEGORY_SO;
    ...
    if (codepoint > 129939 && codepoint < 130042) return SFCE_UNICODE_CATEGORY_SO;
    ...
    switch (codepoint) {
        case 908: return SFCE_UNICODE_CATEGORY_LU;
        case 2142: return SFCE_UNICODE_CATEGORY_PO;
        case 2482: return SFCE_UNICODE_CATEGORY_LO;
        case 2519: return SFCE_UNICODE_CATEGORY_MC;
        case 2620: return SFCE_UNICODE_CATEGORY_MN;
        case 2641: return SFCE_UNICODE_CATEGORY_MN;
        case 2654: return SFCE_UNICODE_CATEGORY_LO;
        case 2768: return SFCE_UNICODE_CATEGORY_LO;
        case 2972: return SFCE_UNICODE_CATEGORY_LO;
        case 3024: return SFCE_UNICODE_CATEGORY_LO;
        case 3031: return SFCE_UNICODE_CATEGORY_MC;
        case 3165: return SFCE_UNICODE_CATEGORY_LO;
        case 3517: return SFCE_UNICODE_CATEGORY_LO;
        case 3530: return SFCE_UNICODE_CATEGORY_MN;
        case 3542: return SFCE_UNICODE_CATEGORY_MN;
        case 3716: return SFCE_UNICODE_CATEGORY_LO;
        case 3749: return SFCE_UNICODE_CATEGORY_LO;
        case 3782: return SFCE_UNICODE_CATEGORY_LM;
        case 4295: return SFCE_UNICODE_CATEGORY_LU;
        case 4301: return SFCE_UNICODE_CATEGORY_LU;
        case 4696: return SFCE_UNICODE_CATEGORY_LO;
        case 4800: return SFCE_UNICODE_CATEGORY_LO;
        case 6464: return SFCE_UNICODE_CATEGORY_SO;
        case 8025: return SFCE_UNICODE_CATEGORY_LU;
        case 8027: return SFCE_UNICODE_CATEGORY_LU;
        case 8029: return SFCE_UNICODE_CATEGORY_LU;
        case 11559: return SFCE_UNICODE_CATEGORY_LL;
        case 11565: return SFCE_UNICODE_CATEGORY_LL;
        case 42963: return SFCE_UNICODE_CATEGORY_LL;
        case 44032: return SFCE_UNICODE_CATEGORY_LO;
        case 55203: return SFCE_UNICODE_CATEGORY_LO;
        case 55296: return SFCE_UNICODE_CATEGORY_CS;
        case 64318: return SFCE_UNICODE_CATEGORY_LO;
        case 64975: return SFCE_UNICODE_CATEGORY_SO;
        case 65279: return SFCE_UNICODE_CATEGORY_CF;
        case 65952: return SFCE_UNICODE_CATEGORY_SO;
        case 67592: return SFCE_UNICODE_CATEGORY_LO;
        case 67644: return SFCE_UNICODE_CATEGORY_LO;
        case 67903: return SFCE_UNICODE_CATEGORY_PO;
        case 69837: return SFCE_UNICODE_CATEGORY_CF;
        case 70280: return SFCE_UNICODE_CATEGORY_LO;
        case 70480: return SFCE_UNICODE_CATEGORY_LO;
        case 70487: return SFCE_UNICODE_CATEGORY_MC;
        case 70539: return SFCE_UNICODE_CATEGORY_LO;
        case 70542: return SFCE_UNICODE_CATEGORY_LO;
        case 70594: return SFCE_UNICODE_CATEGORY_MC;
        case 70597: return SFCE_UNICODE_CATEGORY_MC;
        case 71945: return SFCE_UNICODE_CATEGORY_LO;
        case 73018: return SFCE_UNICODE_CATEGORY_MN;
        case 73648: return SFCE_UNICODE_CATEGORY_LO;
        case 94208: return SFCE_UNICODE_CATEGORY_LO;
        case 100343: return SFCE_UNICODE_CATEGORY_LO;
        case 101640: return SFCE_UNICODE_CATEGORY_LO;
        case 110898: return SFCE_UNICODE_CATEGORY_LO;
        case 110933: return SFCE_UNICODE_CATEGORY_LO;
        case 119970: return SFCE_UNICODE_CATEGORY_LU;
        case 119995: return SFCE_UNICODE_CATEGORY_LL;
        case 120134: return SFCE_UNICODE_CATEGORY_LU;
        case 123023: return SFCE_UNICODE_CATEGORY_MN;
        case 123647: return SFCE_UNICODE_CATEGORY_SC;
        case 124415: return SFCE_UNICODE_CATEGORY_PO;
        case 126500: return SFCE_UNICODE_CATEGORY_LO;
        case 126503: return SFCE_UNICODE_CATEGORY_LO;
        case 126521: return SFCE_UNICODE_CATEGORY_LO;
        case 126523: return SFCE_UNICODE_CATEGORY_LO;
        case 126530: return SFCE_UNICODE_CATEGORY_LO;
        case 126535: return SFCE_UNICODE_CATEGORY_LO;
        case 126537: return SFCE_UNICODE_CATEGORY_LO;
        case 126539: return SFCE_UNICODE_CATEGORY_LO;
        case 126548: return SFCE_UNICODE_CATEGORY_LO;
        case 126551: return SFCE_UNICODE_CATEGORY_LO;
        case 126553: return SFCE_UNICODE_CATEGORY_LO;
        case 126555: return SFCE_UNICODE_CATEGORY_LO;
        case 126557: return SFCE_UNICODE_CATEGORY_LO;
        case 126559: return SFCE_UNICODE_CATEGORY_LO;
        case 126564: return SFCE_UNICODE_CATEGORY_LO;
        case 126590: return SFCE_UNICODE_CATEGORY_LO;
        case 129008: return SFCE_UNICODE_CATEGORY_SO;
        case 131072: return SFCE_UNICODE_CATEGORY_LO;
        case 173791: return SFCE_UNICODE_CATEGORY_LO;
        case 173824: return SFCE_UNICODE_CATEGORY_LO;
        case 177977: return SFCE_UNICODE_CATEGORY_LO;
        case 177984: return SFCE_UNICODE_CATEGORY_LO;
        case 178205: return SFCE_UNICODE_CATEGORY_LO;
        case 178208: return SFCE_UNICODE_CATEGORY_LO;
        case 183969: return SFCE_UNICODE_CATEGORY_LO;
        case 183984: return SFCE_UNICODE_CATEGORY_LO;
        case 191456: return SFCE_UNICODE_CATEGORY_LO;
        case 191472: return SFCE_UNICODE_CATEGORY_LO;
        case 192093: return SFCE_UNICODE_CATEGORY_LO;
        case 196608: return SFCE_UNICODE_CATEGORY_LO;
        case 201546: return SFCE_UNICODE_CATEGORY_LO;
        case 201552: return SFCE_UNICODE_CATEGORY_LO;
        case 205743: return SFCE_UNICODE_CATEGORY_LO;
        case 917505: return SFCE_UNICODE_CATEGORY_CF;
        case 983040: return SFCE_UNICODE_CATEGORY_CO;
        case 1048573: return SFCE_UNICODE_CATEGORY_CO;
        case 1048576: return SFCE_UNICODE_CATEGORY_CO;
        case 1114109: return SFCE_UNICODE_CATEGORY_CO;
    }
...
int32_t sfce_codepoint_to_upper(int32_t codepoint)
{
    ...
    switch (codepoint) {
        ...
        case 7303: return 1122;
        case 7304: return 42570;
...
uint8_t sfce_codepoint_width(int32_t codepoint)
{
    ...
    if (codepoint > 4303 && codepoint < 4681) return 1;
    ...
    if (codepoint > 8591 && codepoint < 9258) return 1;
    if (codepoint > 9279 && codepoint < 9291) return 1;
    if (codepoint > 9311 && codepoint < 11124) return 1;
    ...
    if (codepoint > 12271 && codepoint < 12352) return 2;
    ...
    if (codepoint > 12831 && codepoint < 13313) return 2;
    ...
    if (codepoint > 43358 && codepoint < 43389) return 1;
    ...
    if (codepoint > 63742 && codepoint < 64110) return 1;
    ...
    if (codepoint > 65007 && codepoint < 65050) return 1;
    if (codepoint > 65055 && codepoint < 65107) return 1;
    ...
    if (codepoint > 65280 && codepoint < 65471) return 2;
    ...
    if (codepoint > 119647 && codepoint < 119673) return 2;
    ...
    if (codepoint > 126975 && codepoint < 127020) return 1;
    ...
    if (codepoint > 127168 && codepoint < 127184) return 1;
    if (codepoint > 127184 && codepoint < 127222) return 1;
    if (codepoint > 127231 && codepoint < 127406) return 1;
    if (codepoint > 127461 && codepoint < 127491) return 1;
    ...
    if (codepoint > 127743 && codepoint < 128728) return 2;
    if (codepoint > 128731 && codepoint < 128749) return 2;
    if (codepoint > 128751 && codepoint < 128765) return 1;
    ...
    if (codepoint > 129279 && codepoint < 129620) return 1;
    ...
    switch (codepoint) {
        ...
        case 73648: return 1;
        case 94208: return 2;
        case 100343: return 2;
        case 101640: return 2;
        case 110898: return 2;
        case 110933: return 2;
        case 119970: return 1;
        case 119995: return 1;
        case 120134: return 1;
        case 123023: return 1;
        case 123647: return 1;
        case 124415: return 1;
        case 126500: return 1;
        case 126503: return 1;
        case 126521: return 1;
        case 126523: return 1;
        case 126530: return 1;
        case 126535: return 1;
        case 126537: return 1;
        case 126539: return 1;
        case 126548: return 1;
        case 126551: return 1;
        case 126553: return 1;
        case 126555: return 1;
        case 126557: return 1;
        case 126559: return 1;
        case 126564: return 1;
        case 126590: return 1;
        case 129008: return 2;
        case 131072: return 2;
        case 173791: return 2;
        case 173824: return 2;
        case 177977: return 2;
        case 177984: return 2;
        case 178205: return 2;
        case 178208: return 2;
        case 183969: return 2;
        case 183984: return 2;
        case 191456: return 2;
        case 191472: return 2;
        case 192093: return 2;
        case 196608: return 2;
        case 201546: return 2;
        case 201552: return 2;
        case 205743: return 2;
        case 917505: return 1;
        case 983040: return 1;
        case 1048573: return 1;
        case 1048576: return 1;
        case 1114109: return 1;
    }
